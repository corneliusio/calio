...
/* src/components/Day.svelte generated by Svelte v3.0.1 */
...
/* src/components/Calio.svelte generated by Svelte v3.0.1 */
...
function instance$1($$self, $$props, $$invalidate) {
	...
	let dates;
	$$self.$$.update = ($$dirty = { min: 1, max: 1, headers: 1, disabled: 1, view: 1, computed: 1, dates: 1, mode: 1, strict: 1, selection: 1, limit: 1, el: 1, data: 1 }) => {
		...
		if ($$dirty.computed || $$dirty.dates || $$dirty.view || $$dirty.mode || $$dirty.strict || $$dirty.selection || $$dirty.limit || $$dirty.el) { $$invalidate('data', data = {
                ...computed,
                dates,
                view,
                mode,
